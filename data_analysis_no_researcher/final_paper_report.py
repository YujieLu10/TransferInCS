...
#     plot_idx += 1
# save_png_idx += 1
# plt.savefig('../final_paper_report_figure/fig_{}_nr_nr.png'.format(save_png_idx))
# fig = plt.figure()
...
plt.savefig('../final_paper_report_figure/fig_12c_nr.png', bbox_inches = "tight")
fig = plt.figure()
...
#     else:
#         label.set_visible(False)
plt.savefig('../final_paper_report_figure/fig_12b_nr.png', bbox_inches = "tight")
fig = plt.figure()
...
#         label.set_visible(False)
save_png_idx = 8
plt.savefig('../final_paper_report_figure/fig_{}_nr.png'.format(save_png_idx), bbox_inches = "tight")
fig = plt.figure()