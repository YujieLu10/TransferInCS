...
df_paper_pc2s_year = pd.read_csv("df_paper_pc2s_year_non_self_cite.tsv")
...
for conf, paperyear_map in paperyear_map_conf.items():
    ...
    plot_idx += 1
save_png_idx += 1
plt.savefig('../final_paper_report_figure/fig_{}_ns.png'.format(save_png_idx))
fig = plt.figure()
...
save_png_idx += 1
plt.savefig('../final_paper_report_figure/fig_{}_ns.png'.format(save_png_idx), bbox_inches = "tight")
fig = plt.figure()
...
for ind, label in enumerate(plt_.get_xticklabels()):
    if ind % 5 == 0:  # every 10th label is kept
        ...
        label.set_visible(False)
# plt.savefig('../final_paper_report_figure/fig_{}_ns.png'.format(save_png_idx))
plt.savefig('../final_paper_report_figure/fig_12a_ns.png', bbox_inches = "tight")
fig = plt.figure()
...
for ind, label in enumerate(plt_.get_xticklabels()):
    if ind % 5 == 0:  # every 10th label is kept
        ...
        label.set_visible(False)
plt.savefig('../final_paper_report_figure/fig_12c_ns.png', bbox_inches = "tight")
fig = plt.figure()
...
for ind, label in enumerate(plt_.get_xticklabels()):
    if ind % 5 == 0:  # every 10th label is kept
        ...
        label.set_visible(False)
plt.savefig('../final_paper_report_figure/fig_12b_ns.png', bbox_inches = "tight")
fig = plt.figure()